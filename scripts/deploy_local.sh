...
case "${TARGET_ENV}" in
  dev)
    ...
    export JUPYTER_CONTAINER_NAME="credit_scoring_dev_jupyter"
    export MLFLOW_CONTAINER_NAME="credit_scoring_dev_mlflow"
  ...
  prod|main)
    ...
    export JUPYTER_CONTAINER_NAME="credit_scoring_jupyter"
    export MLFLOW_CONTAINER_NAME="credit_scoring_mlflow"
